...
const FeatureGroupTable: React.FC = () => {
  ...
  const defaultViewExpand = () => {
    const expandedTableColumns: TableColumnsType<ExpandedDataType> = [
  ...
  const featureViewColumns: TableColumnsType<FeatureData> = [
    ...
    {
      title: 'Data Model', dataIndex: 'model', key: 'model',
      filters: [
        {
          text: 'Static Table',
