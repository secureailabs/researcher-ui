...
import styles from './StoryViaVideo.module.css';
import { Dropzone, FileMosaic } from '@dropzone-ui/react';
import { useState } from 'react';

export interface IStoryViaVideo {}
...
const StoryViaVideo: React.FC<IStoryViaVideo> = ({}) => {
  ...
  return (
    ...
    >
      ...
      >
        <Dropzone onChange={updateFiles} value={files} label="Upload a video" footer={false}>
          {files.map((file) => (
