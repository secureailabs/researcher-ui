...
const ALL_GENERATED_CONTENT = [
  {
    template_id: '5eba23d9-07dc-4c2e-92e7-047c89918f69',
    values: {
      name: 'John Doe',
      age: '29',
      gender: 'Male',
      ...
      father: 'Steve',
      diagnosis: 'MELAS',
      priority_1: 'Early Diagnosis',
      priority_2: 'Clinical Trials',
      other: 'Advocacy ',
      support_meetings: 'Yes',
      symposium: 'Yes',
      pillar_1: 'Education',
      pillar_2: 'Advocacy',
    ...
    id: '1b6a9493-cee7-48e0-af17-adc39d8910f7',
    state: 'DONE',
    generated:
      "[Your Name]\n[Your Address]\n[City, State, Zip]\n[Email Address]\n[Today’s Date]\n\nDear [Recipient's Name],\n\nI hope this letter finds you well. My name is [Your Name], and I’m writing to you today on behalf of the New Foundation, and specifically, on behalf of an inspiring member of our community, Andy.\n\nAndy, a resident of Ohio, is living with Mitochondrial Encephalomyopathy, Lactic Acidosis, and Stroke-like episodes (MELAS). Despite the challenges this condition presents, Andy has made it his mission to advocate for early diagnosis, participate in clinical trials, and contribute to the educational and advocacy pillars of the UMDF. His commitment to advancing our understanding and treatment of mitochondrial diseases is truly commendable. \n\nMitochondrial diseases are genetic disorders that occur when mitochondria fail to produce enough energy for the cell or organ to function properly. MELAS, in particular, is a severe form that can affect many of the body's systems, particularly the brain and nervous system (encephalo-) and muscles (myopathy). Despite the severity of these diseases, there is currently no standardized pathway to diagnosis and no licensed therapies in the U.S. \n\nThe UMDF is committed to changing this reality. Our Roadmap to a Cure initiative focuses on three main pillars: Diagnosis, Therapeutic Development, and Patient Care. We are working tirelessly to streamline the diagnostic process, develop therapies to alleviate symptoms, and improve patient care. We believe that cultivating the best science is our best hope in achieving these goals.\n\nFor this reason, we are the largest non-governmental funder of basic and translational research designed to bring the best science from the bench to bedside. Since our establishment in 1996, we have awarded 15 million in grants, stimulated 150 million in government grant follow-on funding, and funded and launched 125 labs. We also proudly recognize and fund clinicians at every stage of their professional career, nurturing the most promising science.\n\nHowever, we can't do this alone. We need your help. Your donation can fuel our mission and enable us to support more science dedicated to mitochondrial disease research. With your contribution, we can continue to drive progress in improving diagnoses, facilitating drug development, and enhancing patient care.\n\nFor Ohio residents like Andy, your support can make a significant difference. By donating, you are not just supporting a cause – you are supporting a community of patients, families, and researchers who are dedicated to overcoming mitochondrial diseases.\n\nPlease consider making a donation today. Every dollar counts and every action matters in our fight against mitochondrial disease. Visit www.umdf.org/donate to make your contribution.\n\nThank you for your time, and for your consideration in joining us in this important cause.\n\nSincerely,\n\n[Your Name]\n[Your Title]\nNew Foundation\n",
    error_message: null,
    creation_time: '2024-03-11T17:57:48.968232'
  },
  {
    template_id: '5eba23d9-07dc-4c2e-92e7-047c89918f69',
    values: {
      ...
      father: 'Michael',
      diagnosis: 'LHON',
      priority_1: 'Raising Awareness',
      priority_2: 'Support Research',
      other: 'Patient Support',
      support_meetings: 'Yes',
      symposium: 'No',
      pillar_1: 'Community Engagement',
      pillar_2: 'Research',
      call_to_action: 'Join our cause',
      state: 'California'
    },
    id: '2c2b0ee8-e8c3-4b8e-9d1e-abc28d4c7b9e',
    state: 'DONE',
    generated:
      "[Your Name]\n[Your Address]\n[City, State, Zip]\n[Email Address]\n[Today’s Date]\n\nDear [Recipient's Name],\n\nI hope this letter finds you in good spirits. My name is [Your Name], and I am reaching out to you today on behalf of the Vision Hope Foundation, particularly on behalf of a remarkable member of our community, Emma.\n\nEmma, who resides in California, is bravely facing Leber's Hereditary Optic Neuropathy (LHON). Despite the visual challenges imposed by LHON, Emma has dedicated herself to raising awareness about this genetic disorder, supporting groundbreaking research, and actively participating in patient support groups. Her determination to make a positive impact on the LHON community is truly inspiring.\n\nLHON is a rare mitochondrial disease that primarily affects the eyes and central vision. It can lead to significant vision loss. The condition is often challenging to diagnose and manage due to its genetic nature and the variability of its onset and severity. Despite these challenges, there is hope. Research is ongoing, and advancements in gene therapy and other treatments show promise.\n\nThe Vision Hope Foundation is at the forefront of advocating for individuals like Emma, pushing for increased research funding, promoting patient support, and facilitating community engagement. Our mission is to not only support those directly affected by LHON but also to fund scientific research that aims at finding effective treatments and ultimately a cure.\n\nWe are making strides, but we need your support. Your donation can propel our efforts forward, allowing us to expand our research, increase awareness, and enhance support for patients and their families.\n\nFor California residents like Emma, and indeed for anyone affected by LHON across the globe, your contribution can be life-changing. By donating, you become a part of our community’s fight against LHON, helping to bring hope and tangible support to those in need.\n\nPlease consider contributing to our cause today. Every bit of support helps us move closer to a world without LHON. Visit www.visionhope.org/donate to make your donation.\n\nThank you for considering this crucial cause. Your generosity and support mean everything to us and the LHON community.\n\nWarm regards,\n\n[Your Name]\n[Your Title]\nVision Hope Foundation\n",
    error_message: null,
    creation_time: '2024-03-12T08:23:56.123456'
  }
];
...
const ContentGeneration: React.FC<IContentGeneration> = ({}) => {
  ...
  const [generatedContent, setGeneratedContent] = useState<any[]>(ALL_GENERATED_CONTENT);
  const [rows, setRows] = useState<any[]>(ALL_GENERATED_CONTENT);
